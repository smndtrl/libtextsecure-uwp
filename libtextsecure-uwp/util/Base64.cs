...
namespace libtextsecure.utiltest
{
    ...
    internal class Base64
    {
        ...
        (sbyte)'O', (sbyte)'P', (sbyte)'Q', (sbyte)'R', (sbyte)'S', (sbyte)'T', (sbyte)'U',
        (sbyte)'V', (sbyte)'W', (sbyte)'X', (sbyte)'Y', (sbyte)'Z',
        (sbyte)'a', (sbyte)'b', (sbyte)'c', (sbyte)'d', (sbyte)'e', (sbyte)'f', (sbyte)'g',
        (sbyte)'h', (sbyte)'i', (sbyte)'j', (sbyte)'k', (sbyte)'l', (sbyte)'m', (sbyte)'n',
        (sbyte)'o', (sbyte)'p', (sbyte)'q', (sbyte)'r', (sbyte)'s', (sbyte)'t', (sbyte)'u',
        (sbyte)'v', (sbyte)'w', (sbyte)'x', (sbyte)'y', (sbyte)'z',
        (sbyte)'0', (sbyte)'1', (sbyte)'2', (sbyte)'3', (sbyte)'4', (sbyte)'5',
      ...
      (sbyte)'v', (sbyte)'w', (sbyte)'x', (sbyte)'y', (sbyte)'z',
      (sbyte)'0', (sbyte)'1', (sbyte)'2', (sbyte)'3', (sbyte)'4', (sbyte)'5',
      (sbyte)'6', (sbyte)'7', (sbyte)'8', (sbyte)'9', (sbyte)'-', (sbyte)'_'
    };
      ...
      -9,-9,-9,-9                                 // Decimal 123 - 126
         ...
         * @since 2.3
         */
        /*public static void encode(IBuffer raw, IBuffer encoded)
        {
        ...
        /*public static void encode(IBuffer raw, IBuffer encoded)
        {
            sbyte[] raw3 = new sbyte[3];
            sbyte[] enc4 = new sbyte[4];

            while (raw.hasRemaining())
            {
                uint rem = Math.Min(3, raw.remaining());
                raw.get(raw3, 0, rem);
                Base64.encode3to4(enc4, raw3, rem, Base64.NO_OPTIONS);
                for (int i = 0; i < 4; i++)
                {
         ...
         * @since 1.4
         */
        /*public static String encodeObject(java.io.SerializableObject serializableObject)
        ...
        public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options)// throws java.io.IOException
        {
            ...
            else
            {
                ...
                if (e < outBuff.Length - 1)
                {
                    ...
                    System.Buffer.BlockCopy(outBuff, 0, finalOut, 0, e);
        ...
        sbyte[] destination, int destOffset, int options)
        {
            ...
            if (source == null)
            {
                throw new /*NullPointer*/Exception("Source array was null.");
            }   // end if
            if (destination == null)
            {
                throw new /*NullPointer*/Exception("Destination array was null.");
            }   // end if
        ...
        //throws java.io.IOException
        {
            ...
            if (source == null)
            {
                throw new /*NullPointer*/Exception("Cannot decode null source array.");
            }   // end if
            ...
            sbyte[] b4 = new sbyte[4];     // Four byte buffer from source, eliminating white space
            int b4Posn = 0;               // Keep track of four byte input buffer
            int i = 0;               // Source array counter
            sbyte sbiCrop = 0;               // Low seven bits (ASCII) of input
            sbyte sbiDecode = 0;               // Special value from DECODABET
